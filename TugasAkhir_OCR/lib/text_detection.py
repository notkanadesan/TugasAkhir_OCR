...
#                 cropped_image = self.final[ext_top[1]:ext_bot[1], ext_left[0]:ext_right[0]]
...
#                 cv2.imwrite('crop_{}.jpg'.format(i), cropped_image)
                ...
                for c in contours:
                    ...
                    # to save the images
                    cv2.imwrite('FolderIMG/img_{}.jpg'.format(i), self.final[y:y+h,x:x+w])
                    i += 1
    ...
    def full_OCR(self):
        ...
        for box in boxes:
            ...
            ##cropping image
#             im_crop = self.image_file.crop((b[0],b[1],b[2],b[3]))
#             cv2.imwrite('cropped.jpg', im_crop)
